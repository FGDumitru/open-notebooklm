...
IMPORTANT RULE: Each line of dialogue should be no more than 1000 characters (e.g., can finish within 55-85 seconds)

IMPORTANT RULE: There should be at least 100 interactions between the host and guest.
